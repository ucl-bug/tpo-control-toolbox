...
%COMPORTSNIFF Return list of of connected USB devices 
%
% DESCRIPTION:
%     comPortSniff returns a list of connected USB devices.
%
% USAGE:
%     devs = comPortSniff()
%
% OUTPUTS:
%     devs    - list of connected USB devices
%
% ABOUT:
%     author  - Sonic Concepts, Inc.
